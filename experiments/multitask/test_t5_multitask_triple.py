...
from core.data.collators import T5CollatorEmpChatMultitask
from core.models.huggingface.t5_extended import T5ConditionalGenerationTripleHead
...
model = T5ConditionalGenerationTripleHead(model_version='t5-base',
                                          num_classes=32,
                                          device=DEVICE)
