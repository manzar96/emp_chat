...
from core.data.collators import TransformerVaswaniCollatorEmpChatMultitask
...
from core.trainers import TransformerVaswaniTrainerMultitask

from core.models.transformers.vaswani_double_head import TransformerVaswani_DoubleHead
...
# load data
if options.dataset_name == "empchat":
    collator_fn = TransformerVaswaniCollatorEmpChatMultitask(device='cpu')
...
# create model
model = TransformerVaswani_DoubleHead(options,
                                      dictionary=word2idx,
...
criterion1 = SequenceCrossEntropyLoss(word2idx[
                                          DIALOG_SPECIAL_TOKENS.PAD.value])
criterion2 = nn.CrossEntropyLoss()
import ipdb;ipdb.set_trace()

# create trainer
trainer = TransformerVaswaniTrainerMultitask(model=model,
                                    optimizer=optimizer,
