...
from core.data.empdataset import EmpatheticDataset, EmpatheticDatasetNeg
...
if options.dataset_name == "empchat":
    train_dataset = EmpatheticDatasetNeg("train", options.max_hist_len)
...
# load data
if options.dataset_name == "empchat":
    collator_fn1 = T5CollatorEmpChatEmoNegSampling(device='cpu')
elif "persona":
