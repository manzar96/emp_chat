...
from core.trainers import BlenderBotTrainer
...
if options.modelckpt is not None:
    model = BlenderbotForConditionalGeneration.from_pretrained(options.modelckpt)
else:
...
# create trainer
trainer = BlenderBotTrainer(model=model, optimizer=optimizer,
